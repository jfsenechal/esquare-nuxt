    ...
    <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
      <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
        <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
          ...
          <h2 class="text-3xl font-bold tracking-tight text-gray-900">Où nous trouver</h2>
          ...
          <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">
            <div class="flex gap-x-4">
              ...
              <dd>36J, Rue Victor Libert<br>6900 Marche-en-Famenne</dd>
            </div>
            <div class="flex gap-x-4">
              <dt class="flex-none">
              ...
              <dd><a class="hover:text-gray-900" href="tel:+32491963365">+32 491 96 33 65</a></dd>
            </div>
            <div class="flex gap-x-4">
              <dt class="flex-none">
              ...
              <dd><a class="hover:text-gray-900" href="mailto:info@esquare.be">info@esquare.be</a></dd>
            </div>
          </dl>
        </div>
      </div>
