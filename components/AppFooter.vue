  ...
  <footer class="bg-white relative top-28">
    ...
    <div class="mx-auto max-w-7xl overflow-hidden px-6 sm:py-8 lg:px-8">
      ...
      <div class="mt-10 flex justify-center space-x-10">
        <NuxtLink to="https://www.facebook.com/LeSquareMarche/" class="text-gray-400 hover:text-gray-500"
                  target="_blank">
        ...
        <NuxtLink to="https://www.instagram.com/esquare_marche/" class="text-gray-400 hover:text-gray-500"
                  target="_blank">
